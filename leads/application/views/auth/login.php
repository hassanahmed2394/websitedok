...
<body>
	...
	<nav class="navbar navbar-default navbar-embossed navbar-fixed-top" role="navigation" style="background:#1f1f1f;">
    	...
    	<div class="row">
    		...
    		<div class="col-md-offset-4 col-md-4">
    			...
    			<form action="<?php echo site_url("auth/login");?>" method="post">
    				...
    				<button type="submit" style="background:#1f1f1f;" class="btn btn-primary btn-embossed btn-block margin-top-20" tabindex="4">Log me in please</button>
